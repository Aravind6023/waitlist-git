...
export function Navbar()
{
    ...
    useEffect(() => {
        fetch(`http://localhost:3456/v1/user/getindividualuser/${uniqueid}`)
                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse justify-content-md-start justify-content-lg-end" id="navbarSupportedContent">
                        <ul class="navbar-nav mb-2 mb-lg-0 d-flex align-items-lg-center">
                            ...
                            <li class="nav-item">
                                <Link class="nav-link active" aria-current="page" to={`/home/${uniqueid}`}>Home</Link>
                            </li>
                            <li class="nav-item">
                                <Link class="nav-link" to={`/user_dashboard/${uniqueid}`}>User List</Link>
                            </li>
                        </ul>
                    </div>
                </div>
